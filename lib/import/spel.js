...
var convertArg = function convertArg(spel, conv, config, meta, parentSpel) {
  ...
  if (spel.type == "compound") {
    ...
    // todo: get from conv
    var funcToOpMap = (0, _defineProperty2["default"])((0, _defineProperty2["default"])((0, _defineProperty2["default"])((0, _defineProperty2["default"])((0, _defineProperty2["default"])((0, _defineProperty2["default"])((0, _defineProperty2["default"])((0, _defineProperty2["default"])((0, _defineProperty2["default"])((0, _defineProperty2["default"])({}, ".contains", "like"), ".startsWith", "starts_with"), ".endsWith", "ends_with"), "$contains", "select_any_in"), ".equals", "multiselect_equals"), ".include", "multiselect_include"), ".string", "scontains"), "CollectionUtils.containsAny()", "multiselect_contains"), "collect.contain()", "collect_contain"), "collect.notContain()", "collect_not_contain");
...
var convertToTree = function convertToTree(spel, conv, config, meta) {
  ...
  if (spel.type.indexOf("op-") == 0) {
    ...
    console.log("isBetweenNormal", isBetweenNormal ,"isBetweenRev", isBetweenRev)
    if (isBetween) {
